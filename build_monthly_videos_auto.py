...
from render_v2 import render_frame, build_episode_list
...
def build_part_video(rows, tier_label, month_label, visible_ranks, part_num, total_parts,
    ...
    """Renders every frame rather than cropping a single tall image. The old
    version panned a 1890px table down a 1920px screen, which meant the pan
    moved zero pixels and a third of each video was a still frame."""
    tmpdir = "_frames_tmp"
