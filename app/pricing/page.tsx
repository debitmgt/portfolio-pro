...
export default async function PricingPage(props: { searchParams?: Promise<{ paused?: string }> }) {
  ...
  return (
    <main style={{
      ...
      <HeroBoston />
      {/* This month's ranking video carousel moved inside HeroBoston itself
          (Aug 13, 2026), directly under the "Take control — start free" CTA
          on page one, instead of appearing here after the full hero scroll. */}
